...
# если True  то будет выводить ошибки прямо в браузер
...
# файл к которому обращятся при запросе
ROOT_URLCONF = 'locallibrary.urls'
# настроки для работы с шаблонами
TEMPLATES = [
    {
...
LOGOUT_REDIRECT_URL = '/zooinfo/' # если вышел из системы то перекинет на главную страничку